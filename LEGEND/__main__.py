...
PM_START_TEXT = """
Hello there, I'm [PIKACHU](https://telegra.ph/file/e37a9084e46e1104b6d08.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add PIKACHU BOT to your group 💫",
...
HELP_STRINGS = f"""
*Main Commands :* [PIKACHU](https://telegra.ph/file/e37a9084e46e1104b6d08.jpg)
...
Support them  [N](t.me/pikachubotsupport,[LEGEND BOT](t.me/teamishere),"""
...
def LEGEND_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [(θ‿θ)](https://telegra.ph/file/e37a9084e46e1104b6d08.jpg)"
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [PIKACHU-OP](https://github.com/srinivasop)."
            f"\n\n{dispatcher.bot.first_name}'s source code was rewritten by @PYTHON_CODER_SRINIVAS and @LEGENDX22"
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by @LEGENDX22 AND @PYTHIN_CODER_SRINIVAS spending many sleepless nights.. So, Respect it."
